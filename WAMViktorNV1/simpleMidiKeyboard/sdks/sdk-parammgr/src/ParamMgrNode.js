...
/** @typedef {import('./types.js').ParamMgrOptions} ParamMgrOptions */
/** @typedef {import('./types.js').ParamMgrCallFromProcessor} ParamMgrCallFromProcessor */
/** @typedef {import('./types.js').ParamMgrCallToProcessor} ParamMgrCallToProcessor */
/** @typedef {import('./types.js').ParamMgrNodeMsgIn} ParamMgrNodeMsgIn */
/** @typedef {import('./types.js').ParamMgrNodeMsgOut} ParamMgrNodeMsgOut */
/** @typedef {import('./types.js').ParamMgrNode} IParamMgrNode */

/** @type {typeof import('./TypedAudioWorklet.js').TypedAudioWorkletNode} */
// @ts-ignore
