...
/** @typedef {import('./types.js').ParametersMapping} ParametersMapping */
/** @typedef {import('./types.js').InternalParametersDescriptor} InternalParametersDescriptor */
/** @typedef {import('./types.js').ParametersMappingConfiguratorOptions} ParametersMappingConfiguratorOptions */
